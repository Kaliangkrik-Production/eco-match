...
//                   <button
//                     className="mt-5 mr-5 flex flex-row text-xl font-bold text-black hover:text-gray-800 hover:underline"
...
//                 <button
//                   className="h-10 w-32 rounded-lg bg-white  font-bold text-black hover:bg-gray-300"
...
export default function LeLe() {
  // convert class above to function
  const [province, setProvince] = useState({});
  const [city, setCity] = useState({});
  const [kecamatan, setKecamatan] = useState({});
  const [kelurahan, setKelurahan] = useState({});

  function handleProvinceChange(e: any) {
    setProvince(e.target.value);
  }
  function handleCityChange(e: any) {
    setCity(e.target.value);
  }
  function handleKecamatanChange(e: any) {
    setKecamatan(e.target.value);
  }
  function handleKelurahanChange(e: any) {
      ...
      <div className="mb-10 flex h-full w-full flex-col items-center justify-center bg-white ">
        ...
        <div className="mb-10 flex h-[85rem] w-[90%] flex-col items-center justify-center rounded-xl pb-10 shadow-2xl shadow-black">
          ...
          <div className="mt-10 grid h-[80rem] w-[95%] grid-cols-6 gap-12 rounded-md bg-teal-500 p-8">
            ...
            <div className="col-span-3 flex flex-col">
              <CitySelect onChange={handleCityChange} province={province} />
            </div>
            <div className="col-span-2 flex flex-col">
              <KecamatanSelect onChange={handleKecamatanChange} city={city} />
            </div>
            <div className="col-span-2 flex flex-col">
              <KelurahanSelect
                kecamatan={kecamatan}
