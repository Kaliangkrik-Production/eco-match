        ...
        <div className="flex flex-col items-center justify-center h-screen">
          <div className="flex flex-col items-center justify-center bg-[#97D779] rounded-lg shadow-lg p-8">
            ...
            <div className="flex flex-col w-full">
              ...
              <button type="submit" className="bg-[#FFDF70] text-black rounded-lg px-3 py-2 mt-4">Sign up</button>
              <label className="mt-4">Already have an account? <a href="/login" className="text-[#FE7968] font-bold">Login</a></label>
            </div>
          </div>
        </div>
      </div>
